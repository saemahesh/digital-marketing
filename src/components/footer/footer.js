        ...
        <Box sx={styles.footer.footerTopArea}>
          ...
          <div>
            ...
            <div className="who-are-we">
              Robomate is one of the pioneers in Marketing automation and
              Website Designer Company in India. We Lead international
              customers. We believe that every business, irrespective of its
              size small, medium or big looks for a way to communicate with its
              targeted audience.
            </div>
          </div>
          <div style={{ display: "grid", width: "311px" }}>
            ...
            {/* <div className="header-info-box">
              <img
                src={Satisfaction}
                width="150px"
                alt="Robomate - Best IT Service Provider"
              />
            </div> */}
          </div>
        </Box>
      ...
      <div>
        ...
        >
          <a
            ...
            title="Whatspp Now For Inquiry"
            target="_blank"
          >
            <img
              className="whatsapp-button"
              src="https://www.truelinesolution.com/public/Assets/User/static_img/whatspp-now-for-free-quotation.gif"
              alt="Whatspp Now For Inquiry"
              title="Whatspp Now For Inquiry"
              width="60px;"
            />
          </a>
        ...
        <div
          ...
          title="Call Now For Inquiry"
        >
          <a href="tel:+916302009818">
            <img
              src="https://www.truelinesolution.com/public/Assets/User/static_img/call-now-for-free-quotation.gif"
              alt="Call Now For Inquiry"
              title="Call Now For Inquiry"
              width="55px;"
            />
          </a>
